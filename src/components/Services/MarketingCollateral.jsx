...
import "./MarketingCollateral.css";
...
const PRODUCTS = [
  {
    ...
    path: "/services/marketing-collateral/saddle-booklet",
    image: saddleimg,
  ...
  },
  {
    ...
    label: "Coffee Table",
    path: "/services/marketing-collateral/coffee-table-book",
    image: coffeeimg,
  ...
  },
  {
    ...
    label: "Perfect Bound",
    path: "/services/marketing-collateral/perfect-bound-booklet",
    image: perfectimg,
  ...
  },
  {
    ...
    path: "/services/marketing-collateral/spiral-comb-coil-booklet",
    image: spiralimg,
  ...
  },
  {
    ...
    path: "/services/marketing-collateral/hard-cover-booklet",
    image: hardimg,
...
const ProductCard = ({ product, openId, setOpenId }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`mc-card${isOpen ? " mc-card--open" : ""}`}
    ...
    >
      ...
      <div className="mc-card-right">
        ...
        <p className="mc-card-tip">
          <span className="mc-tip-label">Crucial tip : </span>
          {product.tip}
        </p>
      </div>
  ...
  return (
    <main className="mc-page">
      ...
      <nav className="mc-breadcrumb" aria-label="Breadcrumb">
        <NavLink to="/services" className="mc-bc-link">Services</NavLink>
        <span className="mc-bc-sep">&gt;</span>
        <span className="mc-bc-current">Marketing &amp; Collateral</span>
      </nav>

      <header className="mc-header">
        <h1 className="mc-title">Marketing &amp; Collateral</h1>
        <p className="mc-desc mc-desc--short">
          Our Marketing &amp; Collateral category offers end-to-end manufacturing for booklets that demand to be noticed.
        </p>
        <p className="mc-desc mc-desc--long">
      ...
      <section className="mc-grid" ref={gridRef} aria-label="Marketing and collateral products">
