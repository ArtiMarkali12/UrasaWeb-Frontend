...
const PRODUCTS = [
  {
    ...
    path: "/services/speciality-cards-invites/saddle-booklet",
    image: saddleimg,
  ...
  },
  {
    ...
    label: "Coffee Table",
    path: "/services/speciality-cards-invites/coffee-table-book",
    image: coffeeimg,
  ...
  },
  {
    ...
    label: "Perfect Bound",
    path: "/services/speciality-cards-invites/perfect-bound-booklet",
    image: perfectimg,
  ...
  },
  {
    ...
    path: "/services/speciality-cards-invites/spiral-comb-coil-booklet",
    image: spiralimg,
  ...
  },
  {
    ...
    path: "/services/speciality-cards-invites/hard-cover-booklet",
    image: hardimg,
...
const ProductCard = ({ product, openId, setOpenId }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`sc-card${isOpen ? " sc-card--open" : ""}`}
    ...
    >
      ...
      <div className="sc-card-right">
        ...
        <p className="sc-card-tip">
          <span className="sc-tip-label">Crucial tip : </span>
          {product.tip}
        </p>
      </div>
  ...
  return (
    <main className="sc-page">
      ...
      <nav className="sc-breadcrumb" aria-label="Breadcrumb">
        <NavLink to="/services" className="sc-bc-link">Services</NavLink>
        <span className="sc-bc-sep">&gt;</span>
        <span className="sc-bc-current">Speciality Cards &amp; Invites</span>
      </nav>

      <header className="sc-header">
        <h1 className="sc-title">Speciality Cards &amp; Invites</h1>
        <p className="sc-desc sc-desc--short">
          Our Speciality Cards &amp; Invites category offers end-to-end manufacturing for booklets that demand to be noticed.
        </p>
        <p className="sc-desc sc-desc--long">
      ...
      <section className="sc-grid" ref={gridRef} aria-label="Speciality cards and invites products">
